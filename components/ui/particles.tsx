...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  // Use theme color for particles - ensure visibility in both light and dark modes
  const particleColor = themeColor === "default"
    ? "#FFA500"
    : (color === "#ffffff" ? themeColors[themeColor]?.primary || "#00796B" : color);
  ...
  }, [color, particleColor, themeColor]);
...
// Recalculate RGB values when particleColor changes
